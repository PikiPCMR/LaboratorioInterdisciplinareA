...
public class ClimateMonitoring {
    ...
    private static void eseguiRegistrazione() {
        ...
        // Esempio:
        boolean registrazioneRiuscita = salvaCredenziali(username, password);
    ...
    private static boolean salvaCredenziali(String username, String password) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(CSV_FILE, true))) {
            // Aggiungi una nuova riga al file CSV con le credenziali
            // Esempio:
            writer.write(username + CSV_SEPARATOR + password);
            writer.newLine();
